class TestDrive {
    public static void main(String[] args) throws InterruptedException {
        ...
        BurgerStore buurgers = new BurgerStore();
        buurgers.orderBurger("chinese");
        buurgers.orderBurger("american");
        buurgers.orderBurger("russian");
    }
}
...
class BurgerStore extends BurgerFactory {
    ...
    Burger createBurger(String type) {
        switch (type) {
            ...
            case "american":
                return new AmericanBurger();/* write your code here */
            case "russian":
                return new RussianBurger();/* write your code here */
            default:
                return null;
        }
    }
